...
/obj/machinery/embedded_controller/Topic(href, href_list)
	...
	// We should now pass it to the program, except that some of our embedded controller types want to block certain commands.
	// TODO - Leshana *sigh* Refactor this to not do such annoying things.  Like make settings or subsytpes of the program.
	//if(program)
