...
/obj/machinery/computer/shuttle_control/web/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	data = list(
		...
		"docking_status" = shuttle.shuttle_docking_controller? shuttle.docking_controller.get_docking_status() : null,
		"docking_override" = shuttle.shuttle_docking_controller? shuttle.docking_controller.override_enabled : null,
