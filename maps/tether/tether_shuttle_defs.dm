...
/datum/shuttle/ferry/escape_pod/large_escape_pod2
	...
	location = 0
	warmup_time = 0
	landmark_station = /area/shuttle/large_escape_pod2/station
	landmark_offsite = /area/shuttle/large_escape_pod2/centcom
	landmark_transition = /area/shuttle/large_escape_pod2/transit
...
/datum/shuttle/autodock/multi/mercenary
	...
	//destination_dock_targets = list("Mercenary base" = "merc_base","Tether spaceport" = "nuke_shuttle_dock_airlock",)
